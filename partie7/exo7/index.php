...
<html lang="fr" dir="ltr">
  ...
  <body>
      <?php
        if (!empty($_POST['gender']) && ($_POST['gender'] == 'M.' || $_POST['gender'] == 'Mme.') && !empty($_POST['lastname']) && preg_match('/^[A-Za-z\séèêëîïàçù-]+$/', $_POST['lastname']) && !empty($_POST['firstname']) && preg_match('/^[A-Za-z\séèêëîïàçù-]+$/', $_POST['lastname'])) {
      ?>
